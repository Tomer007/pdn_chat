...
- [ ] 1. Create CouponManager module
  - [ ] 1.1 Create `app/pdn_admin/coupon_manager.py` with CouponManager class
  ...
  - [ ]* 1.2 Write property tests for code generation and validation
  ...
  - [ ] 1.3 Implement CRUD operations in CouponManager
  ...
  - [ ]* 1.4 Write property tests for CRUD operations
...
- [ ] 2. Checkpoint - Ensure CouponManager tests pass
  - Ensure all tests pass, ask the user if questions arise.

- [ ] 3. Add admin API routes for coupon management
  - [ ] 3.1 Add coupon routes to `app/pdn_admin/admin_routes.py`
  ...
  - [ ]* 3.2 Write unit tests for admin API routes
...
- [ ] 4. Extend questionnaire login to accept coupon codes
  - [ ] 4.1 Modify `app/pdn_diagnose/diagnosis_routes.py` login endpoint
  ...
  - [ ]* 4.2 Write property tests for coupon validation and redemption
...
- [ ] 6. Create admin dashboard coupon widget
  - [ ] 6.1 Add coupon widget section to `app/pdn_admin/templates/admin_dashboard.html`
  ...
  - [ ] 6.2 Add coupon code input to diagnose login page
  ...
  - [ ] 6.3 Display coupon code as read-only in user form
  ...
  - [ ] 6.4 Add coupon column to diagnosed users table
